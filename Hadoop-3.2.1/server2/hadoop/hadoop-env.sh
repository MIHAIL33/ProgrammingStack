...
export HDFS_NAMENODE_USER="master"
export HDFS_DATANODE_USER="master"
export HDFS_SECONDARYNAMENODE_USER="master"
export YARN_RESOURCEMANAGER_USER="master"
export YARN_NODEMANAGER_USER="master"
